...
!!! tip "GUI State"
    ...
    GUI panels can be moved, resized or docked as desired. GUI state is saved in a file named
...
Now, open the *Aircraft > Avionics > Flight Control* panel. Expand the *Engine* section
