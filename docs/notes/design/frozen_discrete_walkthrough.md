...
`framework_spec.md` [§7.2][s7-2] (genericity scoping), [§10.5][s10-5] (gated tick scheduling),
...
[d-072]: framework_decisions.md#d-072--linearization-surface-three-selector-lists-one-chunked-dual-pass
