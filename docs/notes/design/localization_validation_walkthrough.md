...
*Companion explainer, non-normative. The spec ([§8.4](framework_spec.md#84-localization-mechanics), [§8.6](framework_spec.md#86-event-iteration-at-boundaries-to-quiescence-budgeted); context in [§2.1](framework_spec.md#21-events-two-detection-policies), [§9.4](framework_spec.md#94-inbound-per-device-staging-representation-and-the-drain)) wins
...
The localization trigger is "prior not-holding, holding now" ([§8.4](framework_spec.md#84-localization-mechanics)). Its original
...
explicit ([§8.4](framework_spec.md#84-localization-mechanics)): the localized-event trigger checks run against the **arrival sweep**
...
This is the discrete-driven exactness doctrine ([§2.1](framework_spec.md#21-events-two-detection-policies), row 179) resurfacing: for edges
...
Note the symmetry with the *right*-end degeneracy already in [§8.4](framework_spec.md#84-localization-mechanics): t\* = tₙ₊₁
