...
services. Only the migration outline (§19) remains open.
...
continuous function with **positive = condition holds** (normative;
...
graceful migration, no flag day); one new §14.4 activity ("continuous chain + `f` +
