...
tap register; undefined with them, because their *check* is absent rather than
their reporting: `IllegalStateLeaf` and `MissingProbeValue` — the leaf
vocabulary and `probe_value`'s totality are not policed, an unusable state or
