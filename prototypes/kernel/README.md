...
- **§14 beyond increment 18's slice** (the condition algebra, resolution,
  ...
  `inputs` payload resolves at the root or at a *primitive* whose input the
  flat list already carries to a root input; an `at` prefix stopping at an
