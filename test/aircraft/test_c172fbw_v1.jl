...
function test_control_modes()
    ...
    data_folder = joinpath(dirname(dirname(@__DIR__)),
        normpath("src/aircraft/c172/c172fbw/v1/data"))
    ...
    @test ac.avionics.y.flight_phase === C172FBWv1.phase_gnd

    #set arbitrary control and guidance modes
    av.u.vrt_gdc_mode_req = C172FBWv1.vrt_gdc_alt
    av.u.hor_gdc_mode_req = C172FBWv1.hor_gdc_line
    av.u.lon_ctl_mode_req = C172FBWv1.lon_EAS_clm
    av.u.lat_ctl_mode_req = C172FBWv1.lat_p_β
    ...
    @test av.y.vrt_gdc_mode === C172FBWv1.vrt_gdc_off
    @test av.y.hor_gdc_mode === C172FBWv1.hor_gdc_off
    @test av.y.lon_ctl_mode === C172FBWv1.lon_direct
    @test av.y.lat_ctl_mode === C172FBWv1.lat_direct
    ...
    @testset verbose = true "lon_thr_ele" begin
        ...
        reinit!(sim, design_point)
        av.u.lon_ctl_mode_req = C172FBWv1.lon_thr_ele
        step!(sim, 0.01, true)
        @test av.y.lon_ctl_mode === C172FBWv1.lon_thr_ele
    ...
    @testset verbose = true "lat_φ_β" begin
        ...
        reinit!(sim, design_point)
        av.u.lon_ctl_mode_req = C172FBWv1.lon_thr_ele
        av.u.lat_ctl_mode_req = C172FBWv1.lat_φ_β
        step!(sim, 0.01, true)
        @test av.y.lat_ctl_mode === C172FBWv1.lat_φ_β
    ...
    @testset verbose = true "lat_p_β" begin
        ...
        av.u.lat_ctl_mode_req = C172FBWv1.lat_p_β
        step!(sim, 0.01, true)
        @test av.y.lat_ctl_mode === C172FBWv1.lat_p_β
    ...
    @testset verbose = true "lat_χ_β" begin
        ...
        reinit!(sim, design_point)
        av.u.lon_ctl_mode_req = C172FBWv1.lon_thr_ele
        av.u.lat_ctl_mode_req = C172FBWv1.lat_χ_β
        step!(sim, 0.01, true)
        @test av.y.lat_ctl_mode === C172FBWv1.lat_χ_β
    ...
    @testset verbose = true "lon_thr_q" begin
        ...
        av.u.lon_ctl_mode_req = C172FBWv1.lon_thr_q
        av.u.lat_ctl_mode_req = C172FBWv1.lat_φ_β
        step!(sim, 0.01, true)
        @test av.y.lon_ctl_mode === C172FBWv1.lon_thr_q
    ...
    @testset verbose = true "lon_thr_θ" begin
        ...
        av.u.lon_ctl_mode_req = C172FBWv1.lon_thr_θ
        av.u.lat_ctl_mode_req = C172FBWv1.lat_φ_β
        step!(sim, 0.01, true)
        @test av.y.lon_ctl_mode === C172FBWv1.lon_thr_θ
    ...
    @testset verbose = true "lon_thr_EAS" begin
        ...
        av.u.lon_ctl_mode_req = C172FBWv1.lon_thr_EAS
        av.u.lat_ctl_mode_req = C172FBWv1.lat_φ_β
        step!(sim, 0.01, true)
        @test av.y.lon_ctl_mode === C172FBWv1.lon_thr_EAS
    ...
    @testset verbose = true "lon_EAS_q" begin
        ...
        av.u.lon_ctl_mode_req = C172FBWv1.lon_EAS_q
        av.u.lat_ctl_mode_req = C172FBWv1.lat_φ_β
        step!(sim, 0.01, true)
        @test av.y.lon_ctl_mode === C172FBWv1.lon_EAS_q
    ...
    @testset verbose = true "lon_EAS_θ" begin
        ...
        av.u.lon_ctl_mode_req = C172FBWv1.lon_EAS_θ
        av.u.lat_ctl_mode_req = C172FBWv1.lat_φ_β
        step!(sim, 0.01, true)
        @test av.y.lon_ctl_mode === C172FBWv1.lon_EAS_θ
    ...
    @testset verbose = true "lon_EAS_clm" begin
        ...
        av.u.lat_ctl_mode_req = C172FBWv1.lat_φ_β
        step!(sim, 0.01, true)
        @test av.y.lon_ctl_mode === C172FBWv1.lon_EAS_clm
...
function test_guidance_modes()
    ...
    @testset verbose = true "Altitude Guidance" begin
        ...
        av.u.lat_ctl_mode_req = C172FBWv1.lat_φ_β
        step!(sim, 0.01, true)
        @test av.y.vrt_gdc_mode === C172FBWv1.vrt_gdc_alt
        @test av.y.lon_ctl_mode === C172FBWv1.lon_EAS_clm
