...
using Flight.FlightAircraft.C172MCSBase

export test_c172mcs_base


function test_c172mcs_base()
    @testset verbose = true "Cessna172MCSBase" begin
...
function test_system_methods()
        ...
        @testset verbose = true "System Methods" begin
            ...
            ac_LTF = System(Cessna172MCSBase(LTF()));
            ac_ECEF = System(Cessna172MCSBase(ECEF()));
            ac_NED = System(Cessna172MCSBase(NED()));
...
function test_sim(; save::Bool = true)
    ...
    @testset verbose = true "Simulation" begin
        ...
        world = SimpleWorld(Cessna172MCSBase()) |> System;
        ...
        save && save_plots(kin_plots, save_folder = joinpath("tmp", "test_c172mcs_base", "sim", "kin"))
        save && save_plots(air_plots, save_folder = joinpath("tmp", "test_c172mcs_base", "sim", "air"))
        save && save_plots(rb_plots, save_folder = joinpath("tmp", "test_c172mcs_base", "sim", "rigidbody"))
