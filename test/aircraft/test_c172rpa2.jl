...
export test_c172rpa2


function test_c172rpa2()
    @testset verbose = true "Cessna172X2" begin
...
function test_sim(; save::Bool = true)
    ...
    ac = Cessna172RPA2(WA(), trn) |> System;
    ...
    save && save_plots(kin_plots, save_folder = joinpath("tmp", "test_c172rpa2", "sim", "kin"))
    save && save_plots(air_plots, save_folder = joinpath("tmp", "test_c172rpa2", "sim", "air"))
