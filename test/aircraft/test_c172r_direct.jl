...
function test_system_methods()
        ...
        @testset verbose = true "System Methods" begin
            ...
            ac_LTF = System(Cessna172RDirect(LTF()));
            ac_ECEF = System(Cessna172RDirect(ECEF()));
            ac_NED = System(Cessna172RDirect(NED()));
...
function test_sim(; save::Bool = true)
    ...
    @testset verbose = true "Simulation" begin
        ...
        world = SimpleWorld(Cessna172RDirect()) |> System;
        ...
        save && save_plots(kin_plots, save_folder = joinpath("tmp", "test_c172r_direct", "sim", "kin"))
        save && save_plots(air_plots, save_folder = joinpath("tmp", "test_c172r_direct", "sim", "air"))
        save && save_plots(rb_plots, save_folder = joinpath("tmp", "test_c172r_direct", "sim", "rigidbody"))
