...
#3) Create the NewContinuousModel type, and its associated methods. test it with
#   a NewEThruster ComponentGroup.
...
#iteration, it can go directly to saveval without copying, because it is NOT the
