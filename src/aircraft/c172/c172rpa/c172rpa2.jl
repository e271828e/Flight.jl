...
function Systems.f_ode!(::System{<:C172RPA2.Sensors}, ::System{<:C172RPA.Vehicle})
    nothing
end

function Systems.init!(sensors::System{<:C172RPA2.Sensors},
...
Systems.f_ode!(::System{<:C172RPA2.Computing}, ::System{<:C172RPA.Vehicle}) = nothing

function AircraftBase.assign!(components::System{<:C172RPA.Components},
                          computing::System{<:C172RPA2.Computing})
    AircraftBase.assign!(components, computing.ctl)
end

function Systems.init!(computing::System{<:C172RPA2.Computing},
                            vehicle::System{<:C172RPA.Vehicle})
...
function GUI.draw!(computing::System{<:C172RPA2.Computing},
                    vehicle::System{<:C172RPA.Vehicle},
                    p_open::Ref{Bool} = Ref(true),
                    label::String = "Cessna 172X2 Computing")
...
function AircraftBase.assign!(components::System{<:C172RPA.Components},
                          avionics::System{<:C172RPA2.Avionics})
    AircraftBase.assign!(components, avionics.cmp)
end

function Systems.init!(avionics::System{<:C172RPA2.Avionics},
                            vehicle::System{<:C172RPA.Vehicle})
...
function GUI.draw!(avionics::System{<:C172RPA2.Avionics},
                    vehicle::System{<:C172RPA.Vehicle},
                    p_open::Ref{Bool} = Ref(true),
                    label::String = "Cessna 172X2 Avionics")
...
const Cessna172RPA2{K, T, A} = Cessna172RPA{K, T, A} where {
    K <: AbstractKinematicDescriptor, T <: AbstractTerrain, A <: C172RPA2.Avionics}

function Cessna172RPA2(kinematics = WA(), terrain = HorizontalTerrain())
    AircraftBase.Aircraft(C172RPA.Vehicle(kinematics, terrain), C172RPA2.Avionics())
end
...
function Systems.assign_input!(sys::System{<:Cessna172RPA2},
                                data::JoystickData,
                                mapping::IOMapping)
