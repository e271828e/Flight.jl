...
function generate_aero_data(fname = joinpath(@__DIR__, "c172_aero.h5"))
...
function generate_aero_lookup(fname = joinpath(@__DIR__, "c172_aero.h5"))
...
#any Actuation system suitable for C172 Components
...
struct MechanicalActuation <: AbstractActuation end
...
function GUI.draw(sys::System{MechanicalActuation}, p_open::Ref{Bool} = Ref(true),
                label::String = "Cessna 172 Mechanical Actuation")
...
function Systems.assign_input!(sys::System{<:MechanicalActuation},
