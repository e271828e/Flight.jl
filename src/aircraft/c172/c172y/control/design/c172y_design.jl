...
function design_lon(; design_point::C172.TrimParameters = C172.TrimParameters(),
    ...
    ac = Cessna172Yv0(NED()) |> Model #linearization requires NED kinematics
    ...
    # @assert tuple(u_labels_pit...) === propertynames(C172YControl.UPitch())
    ...
    P_red_te, params_e2e = let
        ...
        #weight matrices
        Q = C172YControl.XPitch(q = 1, θ = 20, v_x = 0.1/v_norm, v_z = 1/v_norm, α_filt = 0, ele_p = 0) |> diagm
        # R = C172YControl.UPitch(elevator_cmd = 2) |> diagm
        ...
        # @assert tuple(z_labels...) === propertynames(C172YControl.ZPitch())
...
function design_lat(; design_point::C172.TrimParameters = C172.TrimParameters(),
    ...
    P_ar, params_ar2ar = let
        ...
        #weight matrices
        Q = C172YControl.XLat(p = 0, r = 0.1, φ = 0.1, v_x = 0/v_norm, v_y = 0/v_norm, β_filt = 0, ail_p = 0, rud_p = 0) |> diagm
    ...
    P_φβ, params_φβ2ar = let
        ...
        R = C172YControl.ULat(aileron_cmd = 0.05, rudder_cmd = 0.05) |> diagm
