...
const Cessna172Y{K, A} = Aircraft{K, A}
...
function AircraftBase.assign!(vehicle::Model{<:C172Y.Vehicle},
...
function ULinear(vehicle::Model{<:C172Y.Vehicle{NED}})
...
function YLinear(vehicle::Model{<:C172Y.Vehicle{NED}})
...
AircraftBase.ẋ_linear(vehicle::Model{<:C172Y.Vehicle{NED}}) = XLinear(vehicle.ẋ)
AircraftBase.x_linear(vehicle::Model{<:C172Y.Vehicle{NED}}) = XLinear(vehicle.x)
AircraftBase.u_linear(vehicle::Model{<:C172Y.Vehicle{NED}}) = ULinear(vehicle)
AircraftBase.y_linear(vehicle::Model{<:C172Y.Vehicle{NED}}) = YLinear(vehicle)

function AircraftBase.assign_u!(vehicle::Model{<:C172Y.Vehicle{NED}}, u::AbstractVector{Float64})
...
function AircraftBase.assign_x!(vehicle::Model{<:C172Y.Vehicle{NED}}, x::AbstractVector{Float64})
...
include(normpath("control/c172y_ctl.jl"))
