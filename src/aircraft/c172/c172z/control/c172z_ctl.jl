...
#assemble state vector from vehicle
function XLonFull(vehicle::Model{<:C172Z.Vehicle})
...
function AircraftBase.assign!(systems::Model{<:C172Z.Systems},
...
function XLatRed(vehicle::Model{<:C172Z.Vehicle})
...
function GUI.draw!(lat::Model{<:ControlLawsLat},
                    ...
                    label::String = "Cessna172Z Control Laws")
...
function AircraftBase.assign!(systems::Model{<:C172Z.Systems}, mdl::Model{<:ControlLaws})
...
function Modeling.init!(mdl::Model{<:ControlLaws}, vehicle::Model{<:C172Z.Vehicle})
