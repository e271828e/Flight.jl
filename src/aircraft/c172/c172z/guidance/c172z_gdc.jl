...
function AircraftBase.assign!(systems::Model{<:C172Z.Systems},
                          avionics::Model{<:C172Zv1.Avionics})
    AircraftBase.assign!(systems, avionics.ctl)
end

################################# Trimming #####################################

function Modeling.init!(avionics::Model{<:C172Zv1.Avionics},
                            vehicle::Model{<:C172Z.Vehicle})
...
function GUI.draw!(avionics::Model{<:C172Zv1.Avionics},
                    vehicle::Model{<:C172Z.Vehicle},
                    p_open::Ref{Bool} = Ref(true),
                    label::String = "Cessna172Zv1 Avionics")
