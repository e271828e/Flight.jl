...
const Cessna172Z{K, A} = Aircraft{K, A}
...
function AircraftBase.assign!(vehicle::Model{<:C172Z.Vehicle},
...
function ULinear(vehicle::Model{<:C172Z.Vehicle{NED}})
...
function YLinear(vehicle::Model{<:C172Z.Vehicle{NED}})
...
AircraftBase.ẋ_linear(vehicle::Model{<:C172Z.Vehicle{NED}}) = XLinear(vehicle.ẋ)
AircraftBase.x_linear(vehicle::Model{<:C172Z.Vehicle{NED}}) = XLinear(vehicle.x)
AircraftBase.u_linear(vehicle::Model{<:C172Z.Vehicle{NED}}) = ULinear(vehicle)
AircraftBase.y_linear(vehicle::Model{<:C172Z.Vehicle{NED}}) = YLinear(vehicle)

function AircraftBase.assign_u!(vehicle::Model{<:C172Z.Vehicle{NED}}, u::AbstractVector{Float64})
...
function AircraftBase.assign_x!(vehicle::Model{<:C172Z.Vehicle{NED}}, x::AbstractVector{Float64})
...
include(normpath("control/c172z_ctl.jl")); @reexport using .C172ZControl

include(normpath("c172z0.jl")); @reexport using .C172Zv0
include(normpath("c172z1.jl")); @reexport using .C172Zv1
