...
# function Control.Discrete.reset!(sys::System{<:C172MCAS.Avionics})
...
function Systems.f_disc!(avionics::System{<:C172MCAS.Avionics},
                        physics::System{<:C172FBW.Physics}, Δt::Real)
...
function GUI.draw!(avionics::System{<:C172MCAS.Avionics},
...
const Cessna172MCAS{K, T} = C172FBW.Template{K, T, C172MCAS.Avionics} where {
    K <: AbstractKinematicDescriptor, T <: AbstractTerrain}

function Cessna172MCAS(kinematics = LTF(), terrain = HorizontalTerrain())
    C172FBW.Template(kinematics, terrain, C172MCAS.Avionics())
end


##################################### Tools ####################################

function Aircraft.trim!(ac::System{<:Cessna172MCAS},
...
function Aircraft.linearize!(ac::System{<:Cessna172MCAS}, args...; kwargs...)
...
function IODevices.assign!(sys::System{<:Cessna172MCAS}, joystick::Joystick,
